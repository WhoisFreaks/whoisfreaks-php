...
class ASNWHOISApi
{
    ...
    /**
     * Operation asnWhoisWithHttpInfo
     *
     * ASN WHOIS Lookup
     *
    ...
    public function asnWhoisWithHttpInfo($asn, $format = 'json', string $contentType = self::contentTypes['asnWhois'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WhoisFreaks\Model\AsnWhoisResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WhoisFreaks\Model\AsnWhoisResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WhoisFreaks\Model\AsnWhoisResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WhoisFreaks\Model\AsnWhoisResponse',
    ...
    /**
     * Operation asnWhoisAsyncWithHttpInfo
     *
     * ASN WHOIS Lookup
     *
     * @param  string $asn (required)
    ...
    public function asnWhoisRequest($asn, $format = 'json', string $contentType = self::contentTypes['asnWhois'][0])
    {
        ...
        if ($asn === null || (is_array($asn) && count($asn) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $asn when calling asnWhois'
            );
        }



        $resourcePath = '/v2.0/asn-whois';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
