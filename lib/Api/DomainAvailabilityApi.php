...
/**
 * DomainAvailabilityApi Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
...
class DomainAvailabilityApi
{
    ...
    /**
     * Operation bulkDomainAvailabilityV2
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDomainAvailabilityV2'] to see the possible values for this operation
     *
    ...
    /**
     * Operation bulkDomainAvailabilityV2WithHttpInfo
     *
     * Bulk Domain Availability Check
     *
    ...
    public function bulkDomainAvailabilityV2WithHttpInfo($bulkDomainAvailabilityRequest, $domain = null, $format = 'json', string $contentType = self::contentTypes['bulkDomainAvailabilityV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WhoisFreaks\Model\BulkDomainAvailabilityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WhoisFreaks\Model\BulkDomainAvailabilityResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WhoisFreaks\Model\BulkDomainAvailabilityResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WhoisFreaks\Model\BulkDomainAvailabilityResponse',
    ...
    /**
     * Operation bulkDomainAvailabilityV2Async
     *
     * Bulk Domain Availability Check
     *
     * @param  \WhoisFreaks\Model\BulkDomainAvailabilityRequest $bulkDomainAvailabilityRequest (required)
    ...
    /**
     * Operation bulkDomainAvailabilityV2AsyncWithHttpInfo
     *
     * Bulk Domain Availability Check
     *
     * @param  \WhoisFreaks\Model\BulkDomainAvailabilityRequest $bulkDomainAvailabilityRequest (required)
    ...
    public function bulkDomainAvailabilityV2Request($bulkDomainAvailabilityRequest, $domain = null, $format = 'json', string $contentType = self::contentTypes['bulkDomainAvailabilityV2'][0])
    {
        ...
        if ($bulkDomainAvailabilityRequest === null || (is_array($bulkDomainAvailabilityRequest) && count($bulkDomainAvailabilityRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bulkDomainAvailabilityRequest when calling bulkDomainAvailabilityV2'
            );
        }
        ...
        $resourcePath = '/v2.0/domain/availability';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($bulkDomainAvailabilityRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkDomainAvailabilityRequest));
            } else {
                $httpBody = $bulkDomainAvailabilityRequest;
            }
    ...
    /**
     * Operation domainAvailabilityV2
     *
     ...
     * @param  string|null $format format (optional, default to 'json')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainAvailabilityV2'] to see the possible values for this operation
     *
     * @throws \WhoisFreaks\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation domainAvailabilityV2WithHttpInfo
     *
     * Domain Availability Check with Suggestions
     *
     * @param  string $domain The domain name to check (required)
    ...
    public function domainAvailabilityV2WithHttpInfo($domain, $sug = false, $count = 5, $format = 'json', string $contentType = self::contentTypes['domainAvailabilityV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WhoisFreaks\Model\DomainAvailabilityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WhoisFreaks\Model\DomainAvailabilityResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WhoisFreaks\Model\DomainAvailabilityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WhoisFreaks\Model\DomainAvailabilityResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation domainAvailabilityV2Async
     *
     * Domain Availability Check with Suggestions
     *
     * @param  string $domain The domain name to check (required)
    ...
    /**
     * Operation domainAvailabilityV2AsyncWithHttpInfo
     *
     * Domain Availability Check with Suggestions
     *
     * @param  string $domain The domain name to check (required)
    ...
    public function domainAvailabilityV2Request($domain, $sug = false, $count = 5, $format = 'json', string $contentType = self::contentTypes['domainAvailabilityV2'][0])
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainAvailabilityV2'
            );
        }


        if ($count !== null && $count > 100) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling DomainAvailabilityApi.domainAvailabilityV2, must be smaller than or equal to 100.');
        }
        if ($count !== null && $count < 1) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling DomainAvailabilityApi.domainAvailabilityV2, must be bigger than or equal to 1.');
        }
