...
/**
 * SubdomainsApi Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
...
class SubdomainsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subdomains'] to see the possible values for this operation
     *
    ...
    /**
     * Operation subdomainsWithHttpInfo
     *
     * Subdomains Lookup
     *
     * @param  string $apiKey Your WHOISFreaks API key (required)
    ...
    public function subdomainsWithHttpInfo($apiKey, $domain, $after = null, $before = null, $status = null, $page = 1, $format = 'json', string $contentType = self::contentTypes['subdomains'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WhoisFreaks\Model\SubdomainsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WhoisFreaks\Model\SubdomainsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WhoisFreaks\Model\SubdomainsResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WhoisFreaks\Model\SubdomainsResponse',
    ...
    /**
     * Operation subdomainsAsyncWithHttpInfo
     *
     * Subdomains Lookup
     *
     * @param  string $apiKey Your WHOISFreaks API key (required)
    ...
    public function subdomainsRequest($apiKey, $domain, $after = null, $before = null, $status = null, $page = 1, $format = 'json', string $contentType = self::contentTypes['subdomains'][0])
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling subdomains'
            );
        }
