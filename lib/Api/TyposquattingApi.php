...
/**
 * TyposquattingApi Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
...
class TyposquattingApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['typosquatting'] to see the possible values for this operation
     *
    ...
    /**
     * Operation typosquattingWithHttpInfo
     *
     * Typosquatting Lookup
     *
     * @param  string $apiKey Your WHOISFreaks API key (required)
    ...
    public function typosquattingWithHttpInfo($apiKey, $keyword = null, $pattern = null, $pageToken = null, string $contentType = self::contentTypes['typosquatting'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WhoisFreaks\Model\TyposquattingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WhoisFreaks\Model\TyposquattingResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\WhoisFreaks\Model\TyposquattingResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WhoisFreaks\Model\TyposquattingResponse',
    ...
    /**
     * Operation typosquattingAsyncWithHttpInfo
     *
     * Typosquatting Lookup
     *
     * @param  string $apiKey Your WHOISFreaks API key (required)
    ...
    public function typosquattingRequest($apiKey, $keyword = null, $pattern = null, $pageToken = null, string $contentType = self::contentTypes['typosquatting'][0])
    {
        ...
        $resourcePath = '/v3.0/domain/typos';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
