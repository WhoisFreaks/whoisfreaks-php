...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.whoisfreaks.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.17.0/PHP';
    ...
    {
        $report  = 'PHP SDK (WhoisFreaks) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 0.17.0' . PHP_EOL;
