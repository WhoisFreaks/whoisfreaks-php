 ...
 */
class ApiCredits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiCredits';
    ...
    protected static $setters = [
        ...
        'servedRequest' => 'setServedRequest'
    ];
    ...
    protected static $getters = [
        ...
        'servedRequest' => 'getServedRequest'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('servedRequest', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets totalCredits
     *
     * @param int|null $totalCredits totalCredits
     *
     * @return self
     */
    ...
    {
        return $this->container['servedRequest'];
    }

    /**
     * Sets servedRequest
     *
     * @param int|null $servedRequest servedRequest
     *
     * @return self
     */
    public function setServedRequest($servedRequest)
    {
        if (is_null($servedRequest)) {
            throw new \InvalidArgumentException('non-nullable servedRequest cannot be null');
        }
        $this->container['servedRequest'] = $servedRequest;
