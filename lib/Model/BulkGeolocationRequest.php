...
/**
 * BulkGeolocationRequest Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class BulkGeolocationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkGeolocation_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['ips']) > 100)) {
            $invalidProperties[] = "invalid value for 'ips', number of items must be less than or equal to 100.";
        }
    ...
    public function setIps($ips)
    {
        ...
        if ((count($ips) > 100)) {
            throw new \InvalidArgumentException('invalid value for $ips when calling BulkGeolocationRequest., number of items must be less than or equal to 100.');
        }
