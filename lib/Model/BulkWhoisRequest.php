...
/**
 * BulkWhoisRequest Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class BulkWhoisRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkWhois_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['domainNames']) > 100)) {
    ...
    public function setDomainNames($domainNames)
    {
        ...
        if ((count($domainNames) > 100)) {
            throw new \InvalidArgumentException('invalid value for $domainNames when calling BulkWhoisRequest., number of items must be less than or equal to 100.');
        }
