...
/**
 * DateRangeStatus Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class DateRangeStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DateRangeStatus';
    ...
    */
     ...
     * Sets availableFrom
     *
     * @param string|null $availableFrom availableFrom
     *
     * @return self
     */
    public function setAvailableFrom($availableFrom)
    {
        if (is_null($availableFrom)) {
            throw new \InvalidArgumentException('non-nullable availableFrom cannot be null');
        }
    ...
    public function setLastUpdate($lastUpdate)
    {
        if (is_null($lastUpdate)) {
            throw new \InvalidArgumentException('non-nullable lastUpdate cannot be null');
        }
