 ...
 */
class Irt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Irt';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('irtNfy', $data ?? [], null);
    ...
    */
     ...
     * @return string[]|null
     */
    public function getIrtNfy()
    {
        return $this->container['irtNfy'];
    }

    /**
     * Sets irtNfy
     *
     * @param string[]|null $irtNfy irtNfy
     *
     * @return self
     */
    public function setIrtNfy($irtNfy)
    {
        if (is_null($irtNfy)) {
            throw new \InvalidArgumentException('non-nullable irtNfy cannot be null');
        }
        $this->container['irtNfy'] = $irtNfy;
