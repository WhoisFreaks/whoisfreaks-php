...
/**
 * ReputationSignal Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class ReputationSignal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReputationSignal';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('polarity', $data ?? [], null);
    ...
    */
     ...
     * Sets polarity
     *
     * @param string|null $polarity polarity
     *
     * @return self
     */
    ...
    {
        if (is_null($polarity)) {
            throw new \InvalidArgumentException('non-nullable polarity cannot be null');
        }
