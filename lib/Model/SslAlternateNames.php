...
/**
 * SslAlternateNames Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class SslAlternateNames implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SslAlternateNames';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('emailAddresses', $data ?? [], null);
    ...
    */
     ...
     * Sets dnsNames
     *
     * @param string[]|null $dnsNames dnsNames
     *
     * @return self
     */
     ...
     * Sets emailAddresses
     *
     * @param string[]|null $emailAddresses emailAddresses
     *
     * @return self
     */
    public function setEmailAddresses($emailAddresses)
    {
        if (is_null($emailAddresses)) {
            throw new \InvalidArgumentException('non-nullable emailAddresses cannot be null');
        }
