...
/**
 * SslAuthorityInfo Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class SslAuthorityInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SslAuthorityInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ocsp', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets issuers
     *
     * @param string[]|null $issuers issuers
     *
     * @return self
     */
    ...
    {
        if (is_null($ocsp)) {
            throw new \InvalidArgumentException('non-nullable ocsp cannot be null');
        }
