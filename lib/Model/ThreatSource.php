...
/**
 * ThreatSource Class Doc Comment
 *
 * @category Class
 * @package  WhoisFreaks
 * @author   OpenAPI Generator team
 ...
 */
class ThreatSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreatSource';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('threatType', $data ?? [], null);
    ...
    */
     ...
     * Sets indicator
     *
     * @param string|null $indicator indicator
     *
     * @return self
     */
     ...
     * Sets threatType
     *
     * @param string|null $threatType threatType
     *
     * @return self
     */
    public function setThreatType($threatType)
    {
        if (is_null($threatType)) {
            throw new \InvalidArgumentException('non-nullable threatType cannot be null');
        }
